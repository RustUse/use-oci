...
FOCUSED_CRATES := use-oci-digest use-oci-media-type use-oci-annotation use-oci-platform use-oci-tag use-oci-namespace use-oci-hook use-oci-descriptor use-oci-layer use-oci-manifest use-oci-index use-oci-distribution use-oci-reference use-oci-config use-oci-layout use-oci-runtime use-oci-image
FACADE_CRATE := use-oci
